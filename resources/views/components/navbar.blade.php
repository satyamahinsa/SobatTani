<nav class="fixed w-full top-0 left-0 z-50 bg-green-700 border-b-2 border-white" x-data="{ isOpen: false }" >
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/harga-pasar" :active="request()->is('komunitas')">Harga Pasar</x-nav-link>
                        <x-nav-link href="/titik-kesuburan-tanah" :active="request()->is('komunitas')">Titik Kesuburan Tanah</x-nav-link>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    <button type="button" class="relative rounded-full bg-green-800 p-1 text-yellow-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <x-nav-link href="/" :active="request()->is('/')">Home</x-nav-link>
            <x-nav-link href="/kursus" :active="request()->is('kursus')">Kursus</x-nav-link>
            <x-nav-link href="/marketplace" :active="request()->is('marketplace')">Marketplace</x-nav-link>
            <x-nav-link href="/komunitas" :active="request()->is('komunitas')">Komunitas</x-nav-link>
        </div>
