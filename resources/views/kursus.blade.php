    ...
    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div class="flex justify-center my-5">
            <div class="relative w-1/2">
                <input type="text" id="course-filter" class="border rounded p-2 w-full pl-10" placeholder="Cari kursus...">
        ...
        <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <article class="px-3 py-3 flex max-w-xl flex-col items-start justify-between rounded-lg border-solid border-2 border-gray-100 shadow-md course-item" data-name="{{ $kursus->judul }}">
